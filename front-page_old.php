                ...
                <a class="card-link" href="#">
                    <div class="card-inner">
                        ...
                        <div class="card-body">
                            ...
                            <p class="excerpt">
                                2018年8月大手町モールにて「街のちびっこダンス大会」を開催しました。近年はダンス教室に通うお子様も多く、お子様同士や親御様同士の交流の場となればと思い企画いたしました。
                            </p>
                            <div class="buttonBox">
                                <button type="button" class="seeDetail">MORE</button>
                            </div>
                    ...
                    <div class="card-inner">
                        ...
                        <div class="card-body">
                            ...
                            <p class="excerpt">新しい都市の構想を考える
                                LAモールでは2018年8月20日、モール周辺のロサンゼルスの新しい都市構想について、モールにいらっしゃったお客様と考えるカンファレンスを開催いたしました。</p>
                            <div class="buttonBox">
                                <button type="button" class="seeDetail">MORE</button>
                            </div>
                        </div>
            ...
            <li class="news-item">
                <a class="detail-link" href="#">
                    ...
                    <p class="news-text">お客様　各位 師走の候、貴社ますますご清祥のこととお喜び申し上げます。 平素は格別のご高配を賜り、厚くお礼申し上げます。
                        さて、本年（平成30年）の年末年始は、下記の通り休業させていただきますので、よろしくお願いいたしま [&hellip;]</p>
                </a>
            </li>
            <li class="news-item">
                <a class="detail-link" href="#">
                    ...
                    <p class="news-text">美術館「The Art of Park
                        ...
                        この度、2018年11月30日&#12316;2019年1月31日の [&hellip;]</p>
                </a>
            </li>
        </ul>
        <div class="section-buttons">
